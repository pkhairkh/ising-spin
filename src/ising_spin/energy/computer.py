...
class EnergyComputer:
    ...
    Energy hierarchy (v18.2):
      ...
      4. Reservoir (v18.2 NEW): Long-range temporal dynamics via ESN (~50 token lookback)
      5. Document State (SECONDARY): topic/mode/tense/negation/specificity/argument conditioning
      6. Coupling Energy (v18.2 NEW): Factorial state coupling energy (scalar offset)
      7. Hard constraints: POS type penalties, same-word penalty, closed-class double penalty
    ...
    def compute_energy(
        ...
        # 5. Document state energy (SECONDARY)
