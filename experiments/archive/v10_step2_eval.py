#!/usr/bin/env python3
"""v10.0 Step 2: Load model + β sweep + generation"""
import sys, os, time, pickle
import numpy as np

sys.path.insert(0, os.path.join(os.path.dirname(__file__), "src"))
from ising_spin.model import IntegerBoltzmannSampler, LN2_NUM, LN2_DEN, LOG2_SCALE

print("Loading model...")
t0 = time.time()
with open("/home/z/my-project/download/v10_model.pkl", "rb") as f:
    model = pickle.load(f)
...
for factor in [0.5, 0.55, 0.6, 0.7, 0.8, 0.9, 1.0, 1.1]:
...
for prompt in ["the history of", "science and technology", "research shows that"]:
    ...
    if prompt == "the history of":
        ...
        with open(output_path, 'w') as f:
            ...
            f.write(f"Architecture: Recall-primary + Precise Ratio\n")
